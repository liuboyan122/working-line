...
class Trajectory_publisher2(Node):

    def __init__(self):
        super().__init__('trajectory_publsiher_node')
        publish_topic = "/joint_trajectory_controller2/joint_trajectory"
...
def main(args=None):
    ...
    joint_trajectory_object2 = Trajectory_publisher2()

    rclpy.spin(joint_trajectory_object2)
    joint_trajectory_object2.destroy_node()
    rclpy.shutdown()
