...
class Trajectory_publisher5(Node):

    def __init__(self):
        super().__init__('trajectory_publsiher_node')
        publish_topic = "/joint_trajectory_controller5/joint_trajectory"
...
def main(args=None):
    ...
    joint_trajectory_object5 = Trajectory_publisher5()

    rclpy.spin(joint_trajectory_object5)
    joint_trajectory_object5.destroy_node()
    rclpy.shutdown()
