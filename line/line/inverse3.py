...
class Trajectory_publisher3(Node):

    def __init__(self):
        super().__init__('trajectory_publsiher_node')
        publish_topic = "/joint_trajectory_controller3/joint_trajectory"
...
def main(args=None):
    ...
    joint_trajectory_object3 = Trajectory_publisher3()

    rclpy.spin(joint_trajectory_object3)
    joint_trajectory_object3.destroy_node()
    rclpy.shutdown()
